...
public class ListadoTlfLlamadasMayores extends JDialog {
	...
	private ListadoTlfLlamadasMayores(Principal principal) {
		...
		txtMinutos.setFont(new Font("Serif", Font.PLAIN, 18)); // Fuente más
																// grande
		...
		header.setFont(new Font("Serif", Font.PLAIN, 20)); // Igual que otras
															// ventanas
		...
		if (instance == null) {
			...
			if (!instance.isVisible()) {
				...
				UIManager.put("OptionPane.buttonFont", new Font("Serif",
						Font.BOLD, 18));
				UIManager
						.put("OptionPane.background", new Color(240, 240, 240));
