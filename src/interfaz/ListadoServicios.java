                    ...
                    if (selectedRow >= 0) {
                        ...
                        if (servicio != null) {
                            ...
                            if (confirm == JOptionPane.YES_OPTION) {
                                ...
                                // Actualizar la vista si se eliminó correctamente
                                if (eliminado) {
