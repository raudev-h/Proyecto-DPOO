...
public class login extends JFrame {
    ...
    // 1. Variable est�tica para la instancia �nica
    ...
    // 3. M�todo est�tico para obtener la instancia �nica
    ...
    private void inicializarComponentes() {
        // Elementos de dise�o (manteniendo tu estilo original)
        ...
        // Mensaje de error
        mensajeError = new JLabel("Usuario o contrase�a incorrectos");
