...
public class Inicializadora {
    ...
    public static void Inicializar(){
    	...
    	empresa.agregarRepresentante("Mar�a Fernanda P�rez", "05021768480");
        Representante r1 = empresa.getRepresentantes().get(0);
        
        empresa.agregarRepresentante("Luis Alberto G�mez", "05030567702");
        Representante r2 = empresa.getRepresentantes().get(1);
        
        empresa.agregarRepresentante("Ana L�pez Garc�a", "91040312345");
