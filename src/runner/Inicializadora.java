...
public class Inicializadora {
	...
	public static void Inicializar() throws NombreInvalidoException, UbicacionInvalidaException, 
		...
		// Servicios para Personas JurÌdicas
		...
		// Ejemplo de asignaciÛn para pn1 (cliente 0), que tiene 3 servicios (Ìndices 0,1,2):
		...
		// Asignar servicios a Clientes Personas JurÌdicas 
...
//		Agregarle 10 llamadas a los telefonos Moviles obtenidos
		// Llamadas para el tel√©fono m√≥vil 1 (52345678)

     // ==============================================
     // AGREGAR LLAMADAS MANUALMENTE A CADA TELÈFONO
     // ==============================================
     ...
     // Llamadas para el tel√©fono m√≥vil 1 (52345678)
        ...
        // Llamadas para el tel√©fono m√≥vil 2 (58901234)
        ...
        // Llamadas para el tel√©fono m√≥vil 3 (58432109)
     ...
     // Representantes adicionales libres (sin cliente asignado)
        ...
        empresa.agregarRepresentante("Quirino AlmÌbar", "87121210010");
        empresa.agregarRepresentante("XarandÌ CÛsmico", "89111111011");
        empresa.agregarRepresentante("Odalisca Mercurio", "94020212012");
        empresa.agregarRepresentante("YerutÌ Pandora", "80030313013");
