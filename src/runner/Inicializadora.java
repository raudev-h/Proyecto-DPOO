...
public class Inicializadora {
	...
	ProvinciaInvalidaException, CarnetIdentidadInvalidoException, DuplicadosException{
		...
		// ==============================
		// 3) ASIGNAR TEL�FONOS FIJOS A CLIENTES
		// ==============================
		// Personas Naturales
		...
		// ene10: sin fijo si as� lo decides
		...
		empresa.agregarRepresentante("Quirino Alm�bar", "87121210010");
		empresa.agregarRepresentante("Xarand� C�smico", "89111111011");
